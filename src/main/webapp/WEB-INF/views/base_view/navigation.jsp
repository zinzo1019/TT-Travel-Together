...
<nav>
    <ul>
        ...
        <li><a class="child-title">나의 '같이 여행 가요!'</a></li>
        <li><a href="/user/mypage/together/apply" class="child-title" style="padding-left: 10%">내가 지원한 여행 모집</a></li>
        <li><a href="/user/mypage/together" class="child-title" style="padding-left: 10%">내가 작성한 여행 모집</a></li>
